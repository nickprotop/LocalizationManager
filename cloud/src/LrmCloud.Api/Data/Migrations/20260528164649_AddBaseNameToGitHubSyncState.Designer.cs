...
namespace LrmCloud.Api.Data.Migrations
{
    ...
    [Migration("20260528164649_AddBaseNameToGitHubSyncState")]
    partial class AddBaseNameToGitHubSyncState
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LrmCloud.Shared.Entities.Organization", b =>
                {
                    ...
                    b.Property<int?>("GitHubConnectedByUserId")
                        .HasColumnType("integer")
                        .HasColumnName("github_connected_by_user_id");
                    ...
                    b.HasIndex("GitHubConnectedByUserId");
            ...
            modelBuilder.Entity("LrmCloud.Shared.Entities.Project", b =>
                {
                    ...
                    b.Property<string>("GitHubBasePath")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("github_base_path");
                    ...
                    b.Property<string>("GitHubFormat")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("github_format");
                    ...
                    b.Property<bool>("IsSampleProject")
                        .HasColumnType("boolean")
                        .HasColumnName("is_sample_project");
                    ...
                    b.Property<string>("ValidationCacheJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("validation_cache_json");

                    b.Property<DateTime?>("ValidationCachedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("validation_cached_at");
            ...
            modelBuilder.Entity("LrmCloud.Shared.Entities.RefreshToken", b =>
                {
                    ...
                    b.HasIndex("TokenSelector")
                        .IsUnique()
                        .HasFilter("token_selector IS NOT NULL");
            ...
            modelBuilder.Entity("LrmCloud.Shared.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("HasReceivedSampleProject")
                        .HasColumnType("boolean")
                        .HasColumnName("has_received_sample_project");
            ...
            modelBuilder.Entity("LrmCloud.Shared.Entities.Organization", b =>
                {
                    b.HasOne("LrmCloud.Shared.Entities.User", "GitHubConnectedByUser")
                        .WithMany()
                        .HasForeignKey("GitHubConnectedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("GitHubConnectedByUser");
